package com.example.a0106last.adapters
...
import com.example.a0106last.R
import com.example.a0106last.ViewReviewActivity
    ...
    inner class MyViewHolder (val row : View) : RecyclerView.ViewHolder(row) {
        ...
        fun bind(data: ReviewData){
            ...
            row.setOnClickListener {
                var myIntent=Intent(mContext,ViewReviewActivity::class.java)
